...
class Validate:
    "Проверка в ФИО наличия первой заглавной буквы, а также что ФИО состоит только из букв"
...
if __name__ == '__main__':
    student_1 = Student("Петров", "Петр", "Петрович", Path('lessons.csv'))
    ...
    student_2 = Student("Иванов", "Иван", "Иванович", Path('lessons.csv'))
